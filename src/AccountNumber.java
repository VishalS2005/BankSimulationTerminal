...
public class AccountNumber implements Comparable<AccountNumber> {
    ...
    private Branch branch; //Branch object that represents location of bank
    private AccountType type; //AccountType object that represents checking/savings/money market account
    private String number; //a 4-digit number generated by the Random object

    public AccountNumber(Branch branch, AccountType type, String number) { //constructor for AccountNumber
        this.branch = branch;
        this.type = type;
    ...
    /**
     * Compares the serial number portion of two Account Numbers
     *
